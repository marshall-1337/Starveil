...
c("deps.init", function(require, n, c, d)
    ...
    function o._cycle()
        ...
        if o.parentInstance:IsA("GuiBase2d") and
            math.min(o.parentInstance.AbsoluteSize.X, o.parentInstance.AbsoluteSize.Y) < 100 then
            error("Iris Parent Instance is too small")
        end
        local D = o.parentInstance:IsA("GuiBase2d") or o.parentInstance:IsA("CoreGui") or
                      o.parentInstance:IsA("PluginGui") or o.parentInstance:IsA("PlayerGui")
        if D == false then
    ...
    function o.WidgetConstructor(type, H, I, J)
        local K = {
            All = {
                Required = {"Generate", "Discard", "Update", "Args"},
                Optional = {}
            },
            IfState = {
...
c("deps.demoWindow", function(require, n, c, d)
    return function(o)
        ...
        local ae = {
            ...
            InputNum = function()
                o.Tree({"Input Num"})
                local ag, ah, ai, aj, ak, al = o.State(false), o.State(false), o.State(0), o.State(100), o.State(1),
                    o.State("%d")
                local am = o.InputNum({
                    "Input Number",
        ...
        local function au()
            ...
            av({{"Arguments", "Events", "States"}, {"Text: string", "checked: boolean", "isChecked: boolean"},
                {"", "unchecked: boolean", ""}})
            o.End()
            o.NextColumn()
            o.Tree({
            ...
            av({{"Arguments", "Events", "States"}, {"Text: string", "collapsed: boolean", "isUncollapsed: boolean"},
                {"SpanAvailWidth: boolean", "uncollapsed: boolean", ""}, {"NoIndent: boolean", "", ""}})
            o.End()
            o.NextColumn()
            o.Tree({
                "\nIris.InputNum\n",
            ...
            av({{"Arguments", "Events", "States"}, {"Text: string", "numberChanged: boolean", "number: number"},
                {"Increment: number", "", ""}, {"Min: number", "", ""}, {"Max: number", "", ""},
                {"Format: string", "", ""}, {"NoButtons: boolean", "", ""}, {"NoField: boolean", "", ""}})
            o.End()
            o.NextColumn()
            o.Tree({
                "\nIris.InputText\n",
            ...
            av({{"Arguments", "Events", "States"}, {"Text: string", "textChanged: boolean", "text: string"},
                {"TextHint: string", "", ""}})
            o.End()
            o.NextColumn()
            o.Tree({
            ...
            av({{"Arguments", "Events", "States"}, {"NumColumns: number", "", ""}, {"RowBg: boolean", "", ""},
                {"BordersOuter: boolean", "", ""}, {"BordersInner: boolean", "", ""}})
            o.End()
            o.NextColumn()
            o.Tree({
                "\nIris.Window\n",
            ...
            av({{"Arguments", "Events", "States"}, {"Title: string", "closed: boolean", "size: Vector2"},
                ...
                {"NoClose: boolean", "", "scrollDistance: number"}, {"NoMove: boolean", "", ""},
                {"NoScrollbar: boolean", "", ""}, {"NoResize: boolean", "", ""}})
            o.End()
            o.End()
            o.End()
        end
        local function ax()
            local ay = o.Window({"Runtime Info"}, {
                isOpened = ab
            })
            ...
            o.Text({string.format("Window Position: (%d, %d), Window Size: (%d, %d)", ay.position.value.X,
                ay.position.value.Y, ay.size.value.X, ay.size.value.Y)})
            o.PushConfig({
                ItemWidth = UDim.new(0.5, 100)
            })
            local aF = o.InputText({"Enter an ID to learn more about it."}, {
                text = o.State(ay.ID)
            }).text.value;
            o.PopConfig()
            o.Indent()
            ...
            elseif aH then
                ...
                o.NextRow()
                o.Tree({"state has connected widgets:"}, {
                    isUncollapsed = o.State(true)
                })
        ...
        local function bd()
            ...
            local bo = o.Checkbox({"ComputedState (dynamic coupling)"}, {
                isChecked = bm
            })
            local bo = o.Checkbox({"Inverted of above checkbox"}, {
                isChecked = bn
            })
        ...
        local function br()
            ...
            if bs.value == false then
                ...
                o.Checkbox({"BordersOuter"}, {
                    isChecked = bv
                })
                o.Checkbox({"BordersInner"}, {
                    isChecked = bw
                })
                o.Checkbox({"Use Buttons"}, {
                    isChecked = bx
                })
                o.End()
            end
        ...
        return function()
            ...
            o.NextColumn()
            o.Checkbox({"Recursive Window"}, {
                isChecked = a9
            })
            o.NextColumn()
            o.Checkbox({"Widget Info"}, {
                isChecked = aa
            })
            o.NextColumn()
            o.Checkbox({"Runtime Info"}, {
                isChecked = ab
            })
            o.NextColumn()
            o.Checkbox({"Style Editor"}, {
                isChecked = ac
            })
            o.NextColumn()
            o.Checkbox({"Windowless"}, {
                isChecked = ad
            })
            o.End()
            o.Separator()
            ...
            o.Table({3, false, false, false})
            o.NextColumn()
            o.Checkbox({"NoTitleBar"}, {
                isChecked = bz
            })
            o.NextColumn()
            o.Checkbox({"NoBackground"}, {
                isChecked = bA
            })
            o.NextColumn()
            o.Checkbox({"NoCollapse"}, {
                isChecked = bB
            })
            o.NextColumn()
            o.Checkbox({"NoClose"}, {
    ...
    return function(o)
        ...
        local function c2(c3, c4, c5, c6)
            ...
            c3.InputBegan:Connect(function(c8)
                if not (c8.UserInputType == Enum.UserInputType.MouseButton1 or c8.UserInputType ==
            ...
            c3.InputEnded:Connect(function(c8)
                if not (c8.UserInputType == Enum.UserInputType.MouseButton1 or c8.UserInputType ==
                    Enum.UserInputType.Gamepad1) or c7 then
                    return
                end
            ...
            o.WidgetConstructor("Table", false, true, {
                ...
                Update = function(L)
                    ...
                    if L.arguments.RowBg == false then
                        ...
                        for c_, B in L.CellInstances do
                            ...
                            B.BackgroundTransparency = d0 % 2 == 0 and o._config.TableRowBgAltTransparency or
                ...
                ChildAdded = function(L)
                    ...
                    if L.arguments.RowBg ~= false then
                        ...
                        local d6 = d0 % 2 == 0 and o._config.TableRowBgAltTransparency or
                                       o._config.TableRowBgTransparency;
        ...
        do
            ...
            local function dz(L, dA)
                local cW = L.Instance;
                local dx = dl(L)
                return Vector2.new(math.clamp(dA.X, o._config.WindowBorderSize, math.max(o._config.WindowBorderSize,
                    dx.X - cW.WindowButton.AbsoluteSize.X - o._config.WindowBorderSize)),
                    math.clamp(dA.Y, o._config.WindowBorderSize, math.max(o._config.WindowBorderSize, dx.Y -
                        cW.WindowButton.AbsoluteSize.Y - o._config.WindowBorderSize)))
            end
            ...
            bI.InputBegan:Connect(function(c8, dD)
                ...
                if c8.KeyCode == Enum.KeyCode.Tab and
                    (bI:IsKeyDown(Enum.KeyCode.LeftControl) or bI:IsKeyDown(Enum.KeyCode.RightControl)) then
                    dp()
                end
                if c8.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            bI.InputChanged:Connect(function(c8)
                ...
                if dc then
                    ...
                    local dA = dL +
                                   Vector2.new(dg == Enum.LeftRight.Left and dM.X or 0,
            ...
            bI.InputEnded:Connect(function(c8, dD)
                if (c8.UserInputType == Enum.UserInputType.MouseButton1 or c8.UserInputType == Enum.UserInputType.Touch) and
                    d9 then
                    local dI = d8.Instance.WindowButton;
                    d9 = false;
            ...
            o.WidgetConstructor("Window", true, true, {
                ...
                Generate = function(L)
                    ...
                    dR.InputBegan:Connect(function(c8)
                        if c8.UserInputType == Enum.UserInputType.MouseMovement or c8.UserInputType ==
                ...
                GenerateState = function(L)
                    ...
                    if L.state.position == nil then
                        L.state.position = o._widgetState(L, "position", dj and di.state.position.value +
                            Vector2.new(15, 45) or Vector2.new(150, 250))
                    end
